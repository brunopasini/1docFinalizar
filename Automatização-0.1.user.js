...
(function() {
    ...
    // Função para adicionar o botão à página
    function adicionarBotao() {
        // Substitua pelo seletor da div onde deseja inserir o botão
        const targetDiv = document.querySelector('div#mceu_15-body.mce-container-body.mce-flow-layout');
        if (targetDiv) {
            // Cria o botão
